...
const fetchSignedWebSocketFromEulerRoute = createRoute("fetchSignedWebSocketFromEulerRoute", async ({ routeId, roomId, apiClient, webClient, useMobile, session, authenticateWs, country, cursor, options }) => {
	...
	let response;
	try {
		const sessionId = session?.cookie?.value?.sessionId;
	const ttTargetIdc = session?.cookie?.value?.ttTargetIdc;
	response = await apiClient.rooms.fetchWebcastURL(roomId, LIBRARY_IDENTITY, void 0, cursor, webClient.clientHeaders["User-Agent"], true, country, useMobile ? WebcastFetchPlatform.Mobile : WebcastFetchPlatform.Web, void 0, authenticateWs ? xCookieHeader : void 0, sessionId, ttTargetIdc, {
			...options,
...
//#endregion
export { AlreadyConnectedError as $, fetchRoomGiftsFromEulerRoute as A, ControlEvent as B, fetchRoomGiftsRoute as C, fetchRoomInfoFromEulerRoute as D, fetchSignedWebSocketFromEulerRoute as E, LIBRARY_IDENTITY as F, getWebSocketConfigDefaults as G, WebcastEventMap as H, SignConfig as I, WebcastDeserializeConfig as J, WebSocketConfigDefaults as K, createEulerClient as L, CompositeFetchRoute as M, EulerFetchRoute as N, fetchRoomIdFromEulerRoute as O, createRoute as P, validateAndNormalizeUniqueId as Q, VERSION as R, fetchRoomInfoRoute as S, fetchWebcastSignatureFromEulerRoute as T, createWebSocketProvider as U, WebcastEvent as V, generateUniqId as W, deserializeMessage as X, createBaseWebcastPushFrame as Y, deserializeWebSocketMessage as Z, RoomIdRouteConfig as _, getWebConfig as a, InvalidResponseCompositeError as at, fetchRoomInfoFromHtmlRoute as b, Screens as c, InvalidUniqueIdError as ct, getRandomDevicePreset as d, SignAPIError as dt, AlreadyConnectingError as et, getRandomLocationPreset as f, SignatureMissingTokensError as ft, fetchIsLiveComposite as g, IsLiveRouteConfig as h, UserOfflineError as ht, getRandomPresets as i, InvalidRequestError as it, BaseFetchRoute as j, fetchRoomGiftGalleryFromEulerRoute as k, UserAgents as l, PremiumFeatureError as lt, userAgentToDevicePreset as m, TikTokLiveError as mt, HandleError as n, ConnectTimeoutError as nt, Devices as o, InvalidResponseError as ot, getRandomScreenPreset as p, SignatureRateLimitError as pt, WebcastWebConfigDefaults as q, RouteConfig as r, ErrorReason as rt, Locations as s, InvalidSchemaNameError as st, TikTokLiveConnection as t, AuthenticatedWebSocketConnectionError as tt, generateDeviceId as u, SchemaDecodeError as ut, fetchRoomIdComposite as v, sendRoomChatFromEulerRoute as w, fetchRoomInfoFromApiLiveRoute as x, RoomInfoFromHtmlRouteConfig as y, ConnectState as z };

//# sourceMappingURL=lib-YL2P_UWg.js.map